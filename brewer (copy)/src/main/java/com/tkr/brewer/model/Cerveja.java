...
public class Cerveja implements Serializable{
	...
	@Size(min = 2, max = 250, message = "A descrição tem que estar entre 2 e 250")
	...
	@DecimalMax(value = "9999999.99", message = "O valor  da cerveja deve ser maio que R$9.999.999,99")
